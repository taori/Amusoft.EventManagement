...
{
	[TestFixture]
	public class CustomVoidParametersHandlerOrdinaryTests : IntegrityTestBase<CustomVoidParametersHandler, CustomVoidParametersHandlerReceiver, CustomVoidParametersHandlerOrdinarySource>
	{
		[Test]
